...
class Nr3DDataset(Dataset):
    def __init__(
        self,
        split_path = '/home/haibo/haibo_workspace/data/referit3d/nr3d_val_250_refined.json',
    ...
    def __getitem__(self, i):
        ...
        data_dict['easy_or_hard'] = self.annos[i]['easy_or_hard']
        data_dict['dep_or_indep'] = self.annos[i]['dep_or_indep']
        return data_dict
...
#     print(item['scene_id'])
#     print(item['object_name'], item['type'], item['easy_or_hard'], item['dep_or_indep'])
